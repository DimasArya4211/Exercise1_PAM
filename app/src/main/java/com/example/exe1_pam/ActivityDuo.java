...
import com.example.exe1_pam.MainActivity;
import com.example.exe1_pam.ResultActivity;
...
public class ActivityDuo extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (task.isEmpty() || jenis.isEmpty() || time.isEmpty()) {
            ...
            Intent i = new Intent(getApplicationContext(), com.example.exe1_pam.ResultActivity.class);
            i.putExtras(b);
            startActivity(i);
        }
