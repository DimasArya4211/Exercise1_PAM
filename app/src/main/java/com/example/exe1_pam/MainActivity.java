...
import com.example.exe1_pam.ActivityDuo;
import com.example.exe1_pam.Register;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Deklaasi variabl untuk menyimpan nama
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String nama = "Dimas Arya Kusuma";

                //Mengeset password yang benar
                String password = "Kusuma245";
                ...
                if (nama.equals(nama) && password.equals(password)) {
                    ...
                    Intent i = new Intent(getApplicationContext(), ActivityDuo.class);
